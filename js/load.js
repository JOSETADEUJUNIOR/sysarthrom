(function (window, undefined){
	...
	AcceptCookie.prototype = {
		...
		addCookieBar: function(){
			...
			htmlBar += '<p>Utilizamos cookies essenciais e tecnologias semelhantes de acordo com a nossa <a target="_blank" href="../../termo.pdf">Política de Privacidade</a> e, ao continuar navegando, você concorda com estas condições!</p>';
			htmlBar += '<div class="pjAcceptCookieBarActions">';
			htmlBar += '<button type="button" class="pjAcceptCookieBarBtn">Aceitar</button>';
			htmlBar += '</div>';
			htmlBar += '</form>';
			htmlBar += '</div>';
